...
class FfmegExecuter extends command_executor_1.CommandExecutor {
    constructor(logger) {
        super(logger);
    ...
    prompt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nameFile = yield this.promptService.input('Имя файла', 'input');
            return { width, height, path, nameFile };
        });
    }
    build({ width, height, path, nameFile }) {
        const output = this.fileService.getFilePath(path, nameFile, 'mp4');
...
exports.FfmegExecuter = FfmegExecuter;
